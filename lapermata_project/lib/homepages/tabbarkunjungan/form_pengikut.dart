...
import 'package:lapermata_project/homepages/tabbarkunjungan/user_pengikut.dart';
...
typedef OnDeletePengikut();
final foto_ktp_pengikut = TextEditingController();
final foto_selfie_pengikut = TextEditingController();

class UserPengikutForm extends StatefulWidget {
  final UserPengikut userPengikut;
  final state = _UserPengikutFormState();
  final OnDeletePengikut onDelete;

  UserPengikutForm({Key key, this.userPengikut, this.onDelete})
      : super(key: key);
  @override
  _UserPengikutFormState createState() => state;

  bool isValid() => state.validate();
}

class _UserPengikutFormState extends State<UserPengikutForm> {
  ...
  Future getImageGalery() async {
    ...
    setState(() {
      ...
      widget.userPengikut.foto_ktp_pengikut = fotoKartu;
    });
  }
  ...
  Future getImageGaleryDua() async {
    ...
    setState(() {
      ...
      widget.userPengikut.foto_selfie_pengikut = fotoPemegangKartu;
    });
  }
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: FormBuilderDropdown(
                  initialValue: widget.userPengikut.kartuid,
                  onChanged: (val) => widget.userPengikut.kartuid = val,
                  attribute: "Kartu ID",
                  decoration: InputDecoration(labelText: 'Kartu Identitas'),
              ...
              Padding(
                ...
                child: TextFormField(
                  initialValue: widget.userPengikut.nomorid,
                  onSaved: (val) => widget.userPengikut.nomorid = val,
                  validator: (val) =>
              ...
              Padding(
                ...
                child: TextFormField(
                  initialValue: widget.userPengikut.fullname,
                  onSaved: (val) => widget.userPengikut.fullname = val,
                  validator: (val) =>
              ...
              Padding(
                ...
                child: FormBuilderRadio(
                  initialValue: widget.userPengikut.jk,
                  onChanged: (val) => widget.userPengikut.jk = val,
              ...
              Padding(
                padding: EdgeInsets.only(top: 2.0, left: 10.0, right: 10.0),
                child: FormBuilderDropdown(
                  initialValue: widget.userPengikut.hubkeluarga,
                  onChanged: (val) => widget.userPengikut.hubkeluarga = val,
                  attribute: "Hubungan Keluarga",
                  decoration: InputDecoration(labelText: 'Hubungan Keluarga'),
              ...
              Padding(
                padding: EdgeInsets.only(top: 2.0, left: 10.0),
                child: TextFormField(
                  initialValue: widget.userPengikut.alamat,
                  onSaved: (val) => widget.userPengikut.alamat = val,
                  validator: (val) =>
                      val.length > 3 ? null : 'Nama alamat terlalu pendek',
                  decoration:
                      InputDecoration(labelText: 'Alamat', hintText: 'Desa/Kelurahan, Kecamatan'),
                ),
              ),
              Column(
                children: <Widget>[
                  Text('Kirim Foto Pengikut'),
                  SizedBox(
                    height: 10.0,
                  ),
